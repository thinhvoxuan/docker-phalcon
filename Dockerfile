...
RUN /usr/bin/apt-get clean && /usr/bin/apt-get update && apt-get -y install git build-essential curl php5-xdebug php5-dev php5-curl php5-mysqlnd php5-cli php5-gd imagemagick php5-imagick php5-mcrypt php5-intl libpcre3-dev gcc make && \
