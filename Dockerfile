...
RUN /usr/bin/apt-get update && apt-get -y install git build-essential curl imagemagick php5-imagick php5-xdebug php5-dev php5-curl php5-mysqlnd php5-cli php5-gd php5-mcrypt php5-intl php5-redis libpcre3-dev gcc make && \
