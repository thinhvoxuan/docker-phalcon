...
RUN /usr/bin/apt-get update && apt-get -y install build-essential curl php5-dev php5-curl php5-mysql php5-cli php5-gd php5-mcrypt php5-intl libpcre3-dev gcc make && \
